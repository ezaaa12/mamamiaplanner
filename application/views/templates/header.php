                ...
                <nav class=" amber lighten-4">
                    <div class="container">
                        <div class="nav-wrapper ">
                            <a href="#home" class="brand-logo responsive-img logobaru"><img src="<?php echo base_url()?>assets/img/logo/logobaru1.png" alt=""></a>
                            ...
                            <li><a href="" class="brown-text"><i class=" material-icons left">account_circle</i>Masuk atau Daftar</a></li>
                            </ul>
